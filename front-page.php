        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
            ...
            <div class="lg:col-span-2 rounded-xl  overflow-hidden bg-[#f2fcf8] shadow hover:shadow-lg border hover:border-[#a1f9d8]">
                <?php if (has_post_thumbnail()) : ?>
                    ...
                    <img fetchpriority="high" src="<?php the_post_thumbnail_url('full'); ?>" alt="<?php the_title(); ?>" class="w-full aspect-video object-cover" decoding="async" loading="lazy"></a>
                <?php endif; ?>
                ...
                <div class="p-5">
                    ...
                    <div class="flex items-center gap-2 text-sm text-gray-500">
                        <img fetchpriority="high" width="20" height="20" src="<?php echo esc_url($author_image['url'] ?? $fallback_image); ?>" class="w-5 h-5 rounded-full object-cover" alt="<?php the_author(); ?>" decoding="async" loading="lazy">
