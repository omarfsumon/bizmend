...
<section id="author" class="bg-primary-50 p-5 h-[450px] flex items-center">
    <div class="container flex flex-col md:flex-row justify-between gap-6">
        <div class="flex items-center justify-center w-1/4">
            <img width="300px" height="300px" src="<?php echo esc_url($author_image['url'] ?? $fallback_image); ?>" class="rounded-lg object-cover" alt="<?php the_author(); ?>">
        </div>
        <div class="flex flex-col w-3/4">
            <h2 class="text-3xl font-bold mb-4"><?php the_author(); ?></h2>
