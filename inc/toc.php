...
function get_dynamic_toc() {
    ...
    $toc .= '<nav class="toc-nav px-4 pb-4 overflow-y-scroll max-h-[calc(50vh)] custom-scrollbar before:absolute before:bottom-0 before:left-0 before:w-full before:h-5 before:bg-white before:z-10" id="table-of-contents">';
